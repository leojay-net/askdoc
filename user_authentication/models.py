...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    lat = models.DecimalField(max_digits=22, decimal_places=12, blank=False, null=True)
    lon = models.DecimalField(max_digits=22, decimal_places=12, blank=False, null=True)
